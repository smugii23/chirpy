...
const getAllChirpsWithoutFilter = `-- name: GetAllChirpsWithoutFilter :many
SELECT id, created_at, updated_at, body, user_id FROM chirps
`

func (q *Queries) GetAllChirpsWithoutFilter(ctx context.Context) ([]Chirp, error) {
	rows, err := q.db.QueryContext(ctx, getAllChirpsWithoutFilter)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
